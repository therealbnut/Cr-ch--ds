...
function drawVisualization(data,container_id,chart_title) {
        ...
        new google.visualization.PieChart(document.getElementById(container_id)).draw(dataFormatted, {title:chart_title, backgroundColor: { fill: "#829b55", stroke: "#596b3b",strokeWidth: 0}, chartArea:{left:15,top:15,width:"300",height:"150"}});
}
